...
{
    [DbContext(typeof(ReservationSystemMigrationsDbContext))]
    [Migration("20210603193534_AggregatesAddedToDb")]
    partial class AggregatesAddedToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReservationSystem.Reservations.OverduePayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("OverduePayments", "Reservation");
                });

            modelBuilder.Entity("ReservationSystem.Reservations.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ReserverNote")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ReservationSystem.Reservations.ReservationItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReservationItems", "Reservation");
                });

            modelBuilder.Entity("ReservationSystem.Reservations.Resource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("CanBeUsedForEvents")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("Resources", "Reservation");
                });
            ...
            modelBuilder.Entity("ReservationSystem.Reservations.OverduePayment", b =>
                {
                    b.HasOne("ReservationSystem.Reservations.Reservation", null)
